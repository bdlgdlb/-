public class Rational extends Number implements Comparable<Rational> {
	private long[] r = new long[2];//r[0] express numerator, r[1] express denominator

	/** Construct a rational with default porpertise */
	public Rational () {
		this(0, 1);
	}

	/** Constructt a rational with specified numerator and denominator */
	...
	public Rational add(Rational secondRational) {
		long n = r[0] * secondRational.getDenominator() +
			r[0] * secondRational.getNumerator();
		long d = r[1] * secondRational.getDenominator();
		return new Rational(n, d);
	}

	/** Subtract a rational number from thid rational */
